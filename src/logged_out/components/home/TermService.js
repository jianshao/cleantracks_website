  ...
  return (
    <div style={{ padding: "40px", maxWidth: "800px", margin: "auto" }}>
      <Helmet>
        ...
        <meta
          name="description"
          content="This is a page for out term service. This describes the agreement you need to agree to before using our services."
        />
        <meta
          name="keywords"
          content="cleantracks term service"
        />
      </Helmet>
      ...
      <p>
        Welcome to CleanTracks ("Service", "we", "us", "our"). Please read these
        Terms of Service ("Terms") carefully before using our Chrome extension.
      ...
      <p>
        ...
        agree to these Terms. If you do not agree to these Terms, do not use the
        Service.
      </p>
      ...
      <p>
        ...
        subscription plans. Details of the plans, including pricing, features,
        and billing cycle, are available on our website or within the extension.
      </p>
      <p>
        <strong>Billing:</strong> By subscribing to the Service, you authorize
        us to charge your payment method for the subscription fee and any
        applicable taxes. Subscription fees are billed in advance on a recurring
        basis.
      </p>
      <p>
        <strong>Cancellation:</strong> You can cancel your subscription at any
        time. If you cancel, you will continue to have access to the Service
        until the end of your current billing period. No refunds will be issued
        for the remaining period of a subscription.
      </p>
      <Typography variant="body1" paragraph>
        <strong>Refund Policy:</strong> We offer refunds within the first 14
        days of your subscription if you are not satisfied with the Service. To
        request a refund, please contact our support team at{" "}
        <strong>jianshao_@hotmail.com</strong>. Refunds will be processed within
        7-10 business days.
      </Typography>
      ...
      <p>
        <strong>Prohibited Activities:</strong> You agree not to use the Service
        for any illegal or unauthorized purpose, or to engage in any activity
      ...
      <p>
        ...
        limited to text, graphics, logos, and software, are the property of us
      ...
      <p>
        ...
        can be found at
        [https://www.privacypolicies.com/live/4300b75a-da91-4d65-a5b8-bf3b86a1b6b3].
      ...
      <p>
        To the fullest extent permitted by law, CleanTracks shall not be liable
      ...
      <p>
        ...
        of China, without regard to its conflict of law provisions.
      </p>

      <h2>11. Contact Us</h2>
      <p>
        If you have any questions about these Terms, please contact us at{" "}
        <strong>jianshao_@hotmail.com</strong>.
      </p>
    </div>
  );
};
